...
const ColoringDemonstration: React.FC<ColoringDemonstrationProps> = ({ originalImage, coloredImage, isColoring, onTryAgain, onDownload }) => {
  return (
        ...
        {coloredImage ? (
            <div className="w-full flex-1 min-w-[280px]">
                <div className="flex justify-center items-center gap-2 mb-2">
                    <h3 className="text-lg font-semibold text-gray-700">AI Colored</h3>
                    <button
                        onClick={onTryAgain}
                        disabled={isColoring}
                        className="p-1 rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                ...
                <div className="relative aspect-square bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg shadow-inner overflow-hidden flex items-center justify-center">
                    {isColoring ? (
                         ...
                         <div className="text-center text-gray-500 px-4">
                            <p>Select a palette above to see the magic happen!</p>
                        </div>
                    )}
                </div>
            </div>
